      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="rounded-lg overflow-hidden shadow border mb-6" style={{ backgroundColor: colors.cardBg, border: `1px solid ${colors.border}`, width: 400, maxWidth: '100%' }}>
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold mb-2" style={{ color: colors.text.primary }}>{course.title}</h3>
              <p className="mb-4 line-clamp-2" style={{ color: colors.text.secondary }}>{course.description}</p>
              ...
              <div className="flex justify-between items-center">
                <a
                  href="/teacher_class_management/units"
                  className="text-indigo-600 hover:text-indigo-800 font-medium"
                >
                  进入课程
                </a>
                <span className="text-sm text-gray-500">共{course.totalWeeks}周</span>
              </div>
            </div>
          </div>
        </main>
